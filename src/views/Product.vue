                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="product-pic-zoom">
                                <img class="product-big-img" :src="foto_hijab" alt="" />
                            </div>
                            <div class="product-thumbs" v-if="productDetails.galleries.length > 0">
                                <carousel :dots="false" :nav="false" class="product-thumbs-track ps-slider">
                                    ...
                                    :class="ss.photo == foto_hijab ? 'active' : '' ">
...
export default {
  ...
  methods: {
      changeImage(urlImage) {
          this.foto_hijab = urlImage; 
      },
      setDataPicture(data) {
          // replace object productDetails dengan data dari API
          this.productDetails = data;
          // replace calue gambar default dengan data dari API (galleries)
          this.foto_hijab = data.galleries[0].photo;
      },
      saveKeranjang(idProduct, nameProduct, pricePrpduct, photoProduct){
